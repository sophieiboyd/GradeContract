...
params:
  ...
  thesisdeadline: "2026-04-17"
  springbreak: "2026-03-07"
  name: Sophie Boyd
  labs: 11
  portfolios: 10
  grade:
...
- [ ] `r advdate(dayone, 13, topic)`
  `r if(params$labs>=12) paste0(" - Finish Lab 12 by ",startweek,": ",advdate(dayone, 13, assignment=startweek))`
...
- [ ] `r advdate(dayone, 14, topic)`
  ...
  - Finish portfolio piece 7 by `r startweek`:  `r advdate(dayone, 14, assignment=startweek)`
- [ ] `r advdate(dayone, 15, topic)`
  - Finish portfolio pieces 8 and 9 by `r startweek`:  `r advdate(dayone, 15, assignment=startweek)`
